 ...
 */
export async function updateEcr(eICR_ID: string | null, updateWith: ECRUpdate): Promise<void> {
 ...
 */
export async function deleteEcr(eICR_ID: string | null): Promise<ECR | undefined> {
