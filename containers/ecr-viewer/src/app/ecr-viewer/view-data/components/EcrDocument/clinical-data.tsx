...
import {
  ...
  formatDateTime,
  formatStartEndDate,
} from "@/app/ecr-viewer/services/formatDateService";
import {
  formatCodeableConcept,
  formatName,
} from "@/app/ecr-viewer/services/formatService";
import { formatTablesToJSON } from "@/app/ecr-viewer/services/htmlTableService";
import {
  evaluateData,
  noData,
  safeParse,
} from "@/app/ecr-viewer/utils/data-utils";
import {
  evaluateAll,
  evaluateOne,
  evaluateReference,
  evaluateValue,
} from "@/app/ecr-viewer/utils/evaluate";
import fhirPathMappings from "@/app/ecr-viewer/utils/evaluate/fhir-paths";
import { toSentenceCase } from "@/app/ecr-viewer/utils/format-utils";
import {
  AdministeredMedication,
  AdministeredMedicationTableData,
} from "@/app/ecr-viewer/view-data/components/AdministeredMedication";
import { DisplayDataProps } from "@/app/ecr-viewer/view-data/components/DataDisplay";
import EvaluateTable, {
  BaseTable,
  ColumnInfoInput,
} from "@/app/ecr-viewer/view-data/components/EvaluateTable";
import { JsonTable } from "@/app/ecr-viewer/view-data/components/JsonTable";
import {
  returnImmunizations,
  returnProblemsTable,
} from "@/app/ecr-viewer/view-data/components/common";
