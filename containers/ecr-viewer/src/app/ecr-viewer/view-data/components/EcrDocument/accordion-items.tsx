...
import { evaluateEcrMetadata } from "@/app/ecr-viewer/services/ecrMetadataService";
import {
...
} from "@/app/ecr-viewer/services/evaluateFhirDataService";
import { evaluateLabInfoData } from "@/app/ecr-viewer/services/labsService";
import { evaluateAll } from "@/app/ecr-viewer/utils/evaluate";
import fhirPathMappings from "@/app/ecr-viewer/utils/evaluate/fhir-paths";
import { toKebabCase } from "@/app/ecr-viewer/utils/format-utils";
import ClinicalInfo from "@/app/ecr-viewer/view-data/components/ClinicalInfo";
import Demographics from "@/app/ecr-viewer/view-data/components/Demographics";
import EcrMetadata from "@/app/ecr-viewer/view-data/components/EcrMetadata";
import EncounterDetails from "@/app/ecr-viewer/view-data/components/Encounter";
import LabInfo from "@/app/ecr-viewer/view-data/components/LabInfo";
import SocialHistory from "@/app/ecr-viewer/view-data/components/SocialHistory";
import UnavailableInfo from "@/app/ecr-viewer/view-data/components/UnavailableInfo";
import { AccordionItem } from "@/app/ecr-viewer/view-data/types";
