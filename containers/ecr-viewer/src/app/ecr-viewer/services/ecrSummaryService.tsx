...
import { evaluateData } from "@/app/ecr-viewer/utils/data-utils";
import { evaluateAll, evaluateOne } from "@/app/ecr-viewer/utils/evaluate";
import fhirPathMappings from "@/app/ecr-viewer/utils/evaluate/fhir-paths";
import { toTitleCase } from "@/app/ecr-viewer/utils/format-utils";
import { DisplayDataProps } from "@/app/ecr-viewer/view-data/components/DataDisplay";
import { ConditionSummary } from "@/app/ecr-viewer/view-data/components/EcrSummary";
import { LabAccordion } from "@/app/ecr-viewer/view-data/components/LabAccordion";
import {
  returnImmunizations,
  returnProblemsTable,
