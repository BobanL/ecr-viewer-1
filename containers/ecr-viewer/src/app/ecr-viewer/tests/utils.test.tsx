...
import { DataDisplay } from "@/app/ecr-viewer/view-data/components/DataDisplay";
import {
  evaluateClinicalData,
  returnCareTeamTable,
  returnPlannedProceduresTable,
} from "@/app/ecr-viewer/view-data/components/EcrDocument/clinical-data";
import {
  TooltipDiv,
  ToolTipElement,
} from "@/app/ecr-viewer/view-data/components/ToolTipElement";
import { returnProblemsTable } from "@/app/ecr-viewer/view-data/components/common";
