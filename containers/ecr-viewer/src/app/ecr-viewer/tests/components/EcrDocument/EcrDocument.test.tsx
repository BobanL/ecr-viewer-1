...
import { EcrDocument } from "@/app/ecr-viewer/view-data/components/EcrDocument";
import { getEcrDocumentAccordionItems } from "@/app/ecr-viewer/view-data/components/EcrDocument/accordion-items";
